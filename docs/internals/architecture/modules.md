...
│   ├── ObjectSchema.java          # 对象 Schema
│   ├── ArraySchema.java           # 数组 Schema
│   └── ValidateResult.java        # 验证结果
├── jsonpath/
│   ├── JSONPathCompiler.java      # 路径编译器
│   ├── JSONPathSegment.java       # 路径段
│   ├── JSONPathFilter.java        # 过滤器
│   └── JSONPathContext.java       # 上下文
├── filter/
│   ├── Filter.java                # 过滤器接口
